...
真实输入样本保存在 `/home/claude/Projects/Auto-Test-private-inputs-20260728`，权限为 `0700`。旧代码、结果和外部仓库副本保存在 `/home/claude/Projects/Auto-Test-legacy-20260728`，仅用于审计回溯，不属于新实现。
