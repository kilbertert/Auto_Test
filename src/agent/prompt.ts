...
export function codexTestAgentEvidenceDebtAuditPrompt(): string {
...
Do not perform new business writes solely for this audit. When it is complete, reply with a concise summary; the controller will request the final structured result from this same thread.`
}
